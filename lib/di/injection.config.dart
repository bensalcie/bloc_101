...
import '../features/users/presentation/bloc/user_bloc.dart' as _i12;
import '../features/users/presentation/bloc/users_bloc.dart' as _i13;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i12.UserBloc>(
      () => _i12.UserBloc(get<_i10.GetUserUseCase>(), get<int>()));
  gh.factory<_i13.UsersBloc>(() => _i13.UsersBloc(get<_i11.GetUsersUseCase>()));
  return get;
}
